...
{
    public class SAINMovementPlanController : BotBase, IBotClass
    {
    ...
    public sealed class SAINMovementPlan
    {
        ...
        public SAINMovementPlan(BotComponent sain, NavMeshPath directPath, Vector3 endGoal)
        {
            SAIN = sain;
        ...
        {
            if (SAINPlugin.DebugMode && SAINPlugin.DebugSettings.Gizmos.DebugMovementPlan)
            {
