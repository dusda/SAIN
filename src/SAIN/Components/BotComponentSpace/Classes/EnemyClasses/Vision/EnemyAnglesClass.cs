...
namespace SAIN.SAINComponent.Classes.EnemyClasses
{
  public class EnemyAnglesClass : EnemyBase, IBotEnemyClass
  {
    ...
    private static float CalcVerticalAngle(Vector3 enemyDirNormal, Vector3 lookDirection, out float yDiff)
    {
    ...
    private static float CalcHorizontalAngle(Vector3 enemyDirNormal, Vector3 lookDirection)
    {
      enemyDirNormal.y = 0;
      lookDirection.y = 0;
